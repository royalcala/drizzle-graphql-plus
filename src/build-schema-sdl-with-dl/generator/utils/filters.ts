  ...
  for (const [operatorName, operatorValue] of entries) {
    ...
    switch (operatorName) {
      ...
      case "lte": {
        ...
        variants.push(
          opMap[operatorName as keyof typeof opMap](column, singleValue)
        );
        break;
      }
      ...
      case "notIlike": {
        ...
        variants.push(
          opMap[operatorName as keyof typeof opMap](
            column,
      ...
      case "notInArray": {
        ...
        if (operatorName === "inArray") {
          variants.push(inArray(column, arrayValue));
        } else {
          variants.push(notInArray(column, arrayValue));
        }
        break;
      }
